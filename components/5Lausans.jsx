...
function Lausans() {
  ...
  const [text, setText] = useState('Grouping');
  ...
  const MAX_FONT_SIZE = 20; // Maximale Schriftgröße
        ...
        <div className="input-wrapper">
          <textarea
            ...
            style={{
              ...
              padding: isLoremActive ? "0px 18rem 0px 18rem" : " 3rem 5rem 1.5rem 5rem",   // Unterschiedliches Padding je nach Modus ######################
...
<button className="styled-button align-center-button" onClick={alignTextCenter}>
  ...
  <div className="weight-buttons">
    {['100', '400', '700', '900'].map((weight, index) => (
      ...
      <div id="top-section-lausans">
        <section id="displaySection">
          <div id="displayLetter-lausans" className={isGlowing ? 'glow' : ''}
          style={{ fontWeight }}
          >
            {displayLetter}
        ...
        <section id="alphabetPanel-lausans">
