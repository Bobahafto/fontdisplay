...
function Trapster() {
  ...
  const [text, setText] = useState('affects');
        ...
        <div className="input-wrapper">
          <textarea
            ...
            style={{
              ...
              lineHeight: isLoremActive ? "0.88" : "0.8",  // Dynamische Line Height
              padding: isLoremActive ? "0px 22rem 0px 22rem" : " 5.2rem 8rem 0rem 8rem",   // Unterschiedliches Padding je nach Modus ######################
...
<button className="styled-button align-center-button" onClick={alignTextCenter}>
  ...
  <div className="weight-buttons">
    {['100', '400', '700', '900'].map((weight, index) => (
      ...
      <div id="top-section-trapster">
        <section id="displaySection">
          <div id="displayLetter-trapster" className={isGlowing ? 'glow' : ''}
          style={{ fontWeight }}
          >
            {displayLetter}
        ...
        <section id="alphabetPanel-trapster">
