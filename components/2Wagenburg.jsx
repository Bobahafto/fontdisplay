...
function Wagenburg() {
  ...
  the sky changes slowly from pale blue to a deeper shade as the sun lowers and light begins to fade in the streets .`;
        ...
        <div className="input-wrapper">
          <textarea
            ...
            style={{
              ...
              lineHeight: isLoremActive ? "1.1" : "1.0",  // Dynamische Line Height
              padding: isLoremActive ? "47px 22rem 0px 22rem" : " 5.5rem 8rem 1.5rem 8rem",   // Unterschiedliches Padding je nach Modus ######################
...
<button className="styled-button align-center-button" onClick={alignTextCenter}>
  ...
  <div className="weight-buttons">
    {['100', '400', '700', '900'].map((weight, index) => (
      ...
      <div id="top-section-wagenburg">
        <section id="displaySection">
          <div id="displayLetter-wagenburg" className={isGlowing ? 'glow' : ''}
          style={{ fontWeight }}
          >
            {displayLetter}
        ...
        <section id="alphabetPanel-wagenburg">
