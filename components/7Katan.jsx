...
function Katan() {
  ...
  const [text, setText] = useState('Homer');
  const [previousText, setPreviousText] = useState('Homer'); // Speichert den vorherigen Zustand
  ...
  const MIN_FONT_SIZE = 12; // Mindestgröße in rem für normalen Text
        ...
        <div className="input-wrapper">
          <textarea
            ...
            style={{
              ...
              lineHeight: isLoremActive ? "1.22" : "0.8",  // Dynamische Line Height
              padding: isLoremActive ? "0px 22rem 0px 22rem" : " 6.5rem 8rem 0rem 8rem",   // Unterschiedliches Padding je nach Modus ######################
...
<button className="styled-button align-center-button" onClick={alignTextCenter}>
  ...
  <div className="weight-buttons">
    {['100', '400', '700', '900'].map((weight, index) => (
      ...
      <div id="top-section-katan">
        <section id="displaySection">
          <div id="displayLetter-katan" className={isGlowing ? 'glow' : ''}
          style={{ fontWeight }}
          >
            {displayLetter}
        ...
        <section id="alphabetPanel-katan">
