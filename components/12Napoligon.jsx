...
function Napoligon() {
  ...
  const [text, setText] = useState('bright grey');
  ...
  const MIN_FONT_SIZE = 11; // Mindestgröße in rem für normalen Text
        ...
        <div className="input-wrapper">
          <textarea
            ...
            style={{
              ...
              lineHeight: isLoremActive ? "1.1" : "0.8",  // Dynamische Line Height
              padding: isLoremActive ? "0px 22rem 0px 22rem" : " 2.1rem 8rem 0rem 8rem",   // Unterschiedliches Padding je nach Modus ######################
...
<button className="styled-button align-center-button" onClick={alignTextCenter}>
  ...
  <div className="weight-buttons">
    {['100', '400', '700', '900'].map((weight, index) => (
      ...
      <div id="top-section-napoligon">
        <section id="displaySection">
          <div id="displayLetter-napoligon" className={isGlowing ? 'glow' : ''}
          style={{ fontWeight }}
          >
            {displayLetter}
        ...
        <section id="alphabetPanel-napoligon">
