...
function Noodels() {
  ...
  const [text, setText] = useState('was geht');
...
<button className="styled-button align-center-button" onClick={alignTextCenter}>
  ...
  <div className="weight-buttons">
    {['100', '400', '700', '900'].map((weight, index) => (
      ...
      <div id="top-section-noodels">
        <section id="displaySection">
          <div id="displayLetter-noodels" className={isGlowing ? 'glow' : ''}
          style={{ fontWeight }}
          >
            {displayLetter}
        ...
        <section id="alphabetPanel-noodels">
