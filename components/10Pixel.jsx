...
function Pixel() {
  ...
  const [text, setText] = useState('SONAR');
  ...
  const MIN_FONT_SIZE = 16; // Mindestgröße in rem für normalen Text
  const MAX_FONT_SIZE = 25; // Maximale Schriftgröße
        ...
        <div className="input-wrapper">
          <textarea
            ...
            style={{
              ...
              lineHeight: isLoremActive ? "0.88" : "0.6",  // Dynamische Line Height
              padding: isLoremActive ? "0px 22rem 0px 22rem" : " 1rem 8rem 9rem 8rem",   // Unterschiedliches Padding je nach Modus ######################
...
<button className="styled-button align-center-button" onClick={alignTextCenter}>
  ...
  <div className="weight-buttons">
    {['100', '400', '700', '900'].map((weight, index) => (
      ...
      <div id="top-section-pixel">
        <section id="displaySection">
          <div id="displayLetter-pixel" className={isGlowing ? 'glow' : ''}
          style={{ fontWeight }}
          >
            {displayLetter}
        ...
        <section id="alphabetPanel-pixel">
